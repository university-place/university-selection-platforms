...
import { validatePlatformRegisterForm } from '@/lib/validators';
...
export default function PlatformRegisterPage() {
  ...
  const handleSubmit = async (formData: Record<string, string>) => {
    ...
    const validation = validatePlatformRegisterForm(name, username, password, confirmPassword);
    ...
    try {
      const response = await authAPI.platformRegister({
        name,
        username,
        password,
        confirmPassword,
