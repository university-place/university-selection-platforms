  ...
  return (
    <MOEDashboardLayout title="MOE Admin Dashboard" navLinks={NAV_LINKS} theme="purple">
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <h2 className="text-2xl font-bold text-gray-900">University Registry Maintenance</h2>
        <p className="text-gray-600 mt-2">FR-M11 page is available for registration status, verification, and registry governance.</p>
      </div>
    </MOEDashboardLayout>
  );
}
